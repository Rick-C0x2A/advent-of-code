...
intCode_1.processProgram(test1);
intCode_1.processProgram(test2);
intCode_1.processProgram(test3);
intCode_1.processProgram(test4);
console.log(test1);
console.log(test2);
console.log(test3);
console.log(JSON.stringify(test4));
//final result 
intCode_1.processProgram(intCode_1.intProgram);
console.log(JSON.stringify(intCode_1.intProgram));
//# sourceMappingURL=part01-02.js.map